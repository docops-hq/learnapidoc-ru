...
4. Ответить на вопросы о точках доступа API Current weather data :
...
## Часть 3 Точки доступа API

### Практическое занятие 3.1: Поиск опен-сорс проекта

![idea](https://github.com/Starkovden/Documenting_APIs/blob/master/1.%20Introduction%20to%20REST%20APIs/pics/1.jpg?raw=true) **Ищем опен-сорс проект с помощью API документации**
...
### Практическое занятие 3.2 Оценка документации API для ключевых элементов

![idea](https://github.com/Starkovden/Documenting_APIs/blob/master/1.%20Introduction%20to%20REST%20APIs/pics/1.jpg?raw=true) **Оценка документации API для ключевых элементов**
...
3. В документации по каждой ссылке находим информацию:
 - [описание источника](https://github.com/Starkovden/Documenting_APIs/blob/master/3.%20Documenting%20API%20endpoints/3.3.%20Step%201%20Resourse%20description.md);
 - [точки доступа и методы](https://github.com/Starkovden/Documenting_APIs/blob/master/3.%20Documenting%20API%20endpoints/3.4.%20Step%202%20Endpoints%20and%20methods.md)
...
4. Оцените документацию API, ответив на следующие вопросы для каждого раздела:
 ...
 - Точки доступа и методы
    - как сгруппированы точки доступа (на одной или нескольких страницах? Сгруппированы по методу или по источнику)?
    - как определены методы для каждой точки доступа?
 - Параметры
    - сколько параметров у точки доступа (заголовок, путь, строка запроса, параметры тела запроса)?
...
2. Разверните точку доступа **Pet**
...
3. Переключаем на вкладку `Editor` и нажимаем `Generate from JSON` и вставим JSON ответ от точки доступа OpenWeatherMap:
...
## Часть 6 Бессылочный контент документации API

### Практическое занятие 6.1. Оценка бессылочного контента на 3 сайта API документации

![idea](https://github.com/Starkovden/Documenting_APIs/blob/master/1.%20Introduction%20to%20REST%20APIs/pics/1.jpg?raw=true) **Оценка бессылочного контента на 3 сайта API документации**
...
| Бессылочные разделы | Сайт 1 | Сайт 2 | Сайт 3 |
|:--|:--|:--|:--|
| [Обзор API]() ||||
| [Начало работы]() ||||
...
Подробная информация для этого практического занятия находится по ссылке [6.12. Практическое занятие: Оценка бессылочного контента в проекте](https://github.com/Starkovden/Documenting_APIs/blob/master/6.%20Non-reference%20API%20topics/6.12.%20Activity%20Assess%20the%20non_reference%20content%20in%20your%20project.md)
...
Если ввести только git commit, то будет предложено енение. В Windows это новое окно, вероятно, будет окном «Блокнот». Опишите изменения в верхней строке, а затем сохраните и закройте файл Windows.
