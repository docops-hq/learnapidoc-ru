...
Кроме того, информация, которую нужно документировать в настоящий момент, может быть слишком сложна, чтобы просто учиться на ней, просматривая учебники по Safari Books или другим источникам. Но просто начать потреблять продвинутый материал не получается. Сначала нужно изучить основополагающие темы, и такое медленное развитие ощущается как касательное к реальной работе, которая должна быть выполнена.

Например, может понадобиться документировать эквивалент концепций Advanced Calculus. Но чтобы использовать Advanced Calculus, нужно построить фундамент с помощью тригонометрии и алгебры. Если  проводить время за изучением тригонометрии и алгебры вместо концепций Advanced Calculus, которые необходимо документировать, может сложиться впечатление, что нет никакого прогресса в документации.

Стратегия, позволяющая хорошо работать, состоит в том, чтобы разделять обучение на «pomodoros» (техника, названная в честь кухонных таймеров). Используя технику Pomodoro, устанавливается таймер на 20 минут и сосредотачиваемся на своей задаче обучения в течение этого отрезка времени. Можно поставить цель совершить столько "помодоро" в день. Примерно через 1-2 месяца таких регулярных pomodoros прогресс будет очевиден. Пример приложения Focus:

![focus](img/3.png)

Вдобавок, рекомендуется вести список заметок о технических деталях, с которыми идти борьба, во время создания документации, а затем во время pomodoros сосредоточиться на том, что указано в этих технических заметках.
