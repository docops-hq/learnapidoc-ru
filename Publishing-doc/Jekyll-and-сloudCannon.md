...
Например, найдем файл `index.md` кликнем на иконку карандаша (`Edit this file`) обновим данный и закомитим изменения.
