...
Облегченный текстовый формат, который обеспечивает больше семантических функций, чем Markdown. Используется в некоторых генераторах статических сайтов, таких как [Asciidoctor](https://asciidoctor.org/) или [Nanoc](https://nanoc.ws/). См [](http://asciidoc.org/).
...
<p align="center"><img src="../img/authExample.jpg" width="379" height="252"></p>
